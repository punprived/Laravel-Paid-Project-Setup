...
class CrmCustomerController extends Controller
{
    public function index()
    {
        ...
        $crmCustomers = CrmCustomer::with(['status', 'subscriber'])->get();
    ...
    public function create()
    {
        ...
        $subscribers = User::pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.crmCustomers.create', compact('statuses', 'subscribers'));
    }
    ...
    public function edit(CrmCustomer $crmCustomer)
    {
        ...
        $crmCustomer->load('status', 'subscriber');

        return view('admin.crmCustomers.edit', compact('crmCustomer', 'statuses', 'subscribers'));
    }
