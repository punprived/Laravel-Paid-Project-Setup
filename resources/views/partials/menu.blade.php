        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('user_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/permissions*") ? "menu-open" : "" }} {{ request()->is("admin/roles*") ? "menu-open" : "" }} {{ request()->is("admin/users*") ? "menu-open" : "" }} {{ request()->is("admin/subscriber-profiles*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is("admin/permissions*") ? "active" : "" }} {{ request()->is("admin/roles*") ? "active" : "" }} {{ request()->is("admin/users*") ? "active" : "" }} {{ request()->is("admin/subscriber-profiles*") ? "active" : "" }}" href="#">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @endcan
                            @can('subscriber_profile_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.subscriber-profiles.index") }}" class="nav-link {{ request()->is("admin/subscriber-profiles") || request()->is("admin/subscriber-profiles/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-user-cog">

                                        </i>
                                        <p>
                                            {{ trans('cruds.subscriberProfile.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
                ...
                @endcan
                @can('package_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/package-lists*") ? "menu-open" : "" }} {{ request()->is("admin/package-items*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is("admin/package-lists*") ? "active" : "" }} {{ request()->is("admin/package-items*") ? "active" : "" }}" href="#">
                        ...
                        <ul class="nav nav-treeview">
                            @can('package_list_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.package-lists.index") }}" class="nav-link {{ request()->is("admin/package-lists") || request()->is("admin/package-lists/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-align-justify">

                                        </i>
                                        <p>
                                            {{ trans('cruds.packageList.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
                            @can('package_item_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.package-items.index") }}" class="nav-link {{ request()->is("admin/package-items") || request()->is("admin/package-items/*") ? "active" : "" }}">
                ...
                @can('work_order_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.work-orders.index") }}" class="nav-link {{ request()->is("admin/work-orders") || request()->is("admin/work-orders/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-baseball-ball">
