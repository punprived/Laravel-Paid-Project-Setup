...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.packageItem.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.package-items.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user_licence') ? 'is-invalid' : '' }}" type="number" name="user_licence" id="user_licence" value="{{ old('user_licence', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('overview_module_placement') ? 'is-invalid' : '' }}" type="number" name="overview_module_placement" id="overview_module_placement" value="{{ old('overview_module_placement', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_account') ? 'is-invalid' : '' }}" type="number" name="email_account" id="email_account" value="{{ old('email_account', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_account') ? 'is-invalid' : '' }}" type="number" name="customer_account" id="customer_account" value="{{ old('customer_account', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customize_store_page') ? 'is-invalid' : '' }}" type="number" name="customize_store_page" id="customize_store_page" value="{{ old('customize_store_page', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('items_in_store') ? 'is-invalid' : '' }}" type="number" name="items_in_store" id="items_in_store" value="{{ old('items_in_store', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('items_in_customer_store') ? 'is-invalid' : '' }}" type="number" name="items_in_customer_store" id="items_in_customer_store" value="{{ old('items_in_customer_store', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('standard_survey_per_month') ? 'is-invalid' : '' }}" type="number" name="standard_survey_per_month" id="standard_survey_per_month" value="{{ old('standard_survey_per_month', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customize_survey') ? 'is-invalid' : '' }}" type="number" name="customize_survey" id="customize_survey" value="{{ old('customize_survey', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quote_per_month') ? 'is-invalid' : '' }}" type="number" name="quote_per_month" id="quote_per_month" value="{{ old('quote_per_month', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customized_quote') ? 'is-invalid' : '' }}" type="number" name="customized_quote" id="customized_quote" value="{{ old('customized_quote', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('standared_work_order') ? 'is-invalid' : '' }}" type="number" name="standared_work_order" id="standared_work_order" value="{{ old('standared_work_order', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customized_work_order') ? 'is-invalid' : '' }}" type="number" name="customized_work_order" id="customized_work_order" value="{{ old('customized_work_order', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('standard_invoice') ? 'is-invalid' : '' }}" type="number" name="standard_invoice" id="standard_invoice" value="{{ old('standard_invoice', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customized_invoice') ? 'is-invalid' : '' }}" type="number" name="customized_invoice" id="customized_invoice" value="{{ old('customized_invoice', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('api_connection') ? 'is-invalid' : '' }}" type="number" name="api_connection" id="api_connection" value="{{ old('api_connection', '') }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('internal_accounting_system') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="internal_accounting_system" id="internal_accounting_system" value="1" {{ old('internal_accounting_system', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('calendar_usages') ? 'is-invalid' : '' }}" type="number" name="calendar_usages" id="calendar_usages" value="{{ old('calendar_usages', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('trades_mate_access') ? 'is-invalid' : '' }}" type="number" name="trades_mate_access" id="trades_mate_access" value="{{ old('trades_mate_access', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('app_user_licence') ? 'is-invalid' : '' }}" type="number" name="app_user_licence" id="app_user_licence" value="{{ old('app_user_licence', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('project_join') ? 'is-invalid' : '' }}" type="number" name="project_join" id="project_join" value="{{ old('project_join', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('project_share') ? 'is-invalid' : '' }}" type="number" name="project_share" id="project_share" value="{{ old('project_share', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_logins') ? 'is-invalid' : '' }}" type="number" name="customer_logins" id="customer_logins" value="{{ old('customer_logins', '') }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('map_location') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="map_location" id="map_location" value="1" {{ old('map_location', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('supplier_link') ? 'is-invalid' : '' }}" type="number" name="supplier_link" id="supplier_link" value="{{ old('supplier_link', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_api_service') ? 'is-invalid' : '' }}" type="number" name="payment_api_service" id="payment_api_service" value="{{ old('payment_api_service', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vehicles') ? 'is-invalid' : '' }}" type="number" name="vehicles" id="vehicles" value="{{ old('vehicles', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rams_documents_per_month') ? 'is-invalid' : '' }}" type="number" name="rams_documents_per_month" id="rams_documents_per_month" value="{{ old('rams_documents_per_month', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contractor_user_accounts') ? 'is-invalid' : '' }}" type="number" name="contractor_user_accounts" id="contractor_user_accounts" value="{{ old('contractor_user_accounts', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('text_message_service') ? 'is-invalid' : '' }}" type="number" name="text_message_service" id="text_message_service" value="{{ old('text_message_service', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_system_license') ? 'is-invalid' : '' }}" type="number" name="phone_system_license" id="phone_system_license" value="{{ old('phone_system_license', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('internal_messaging') ? 'is-invalid' : '' }}" type="number" name="internal_messaging" id="internal_messaging" value="{{ old('internal_messaging', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('live_chat') ? 'is-invalid' : '' }}" type="number" name="live_chat" id="live_chat" value="{{ old('live_chat', '') }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('tenders_list') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="tenders_list" id="tenders_list" value="1" {{ old('tenders_list', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('internal_blacklist') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="internal_blacklist" id="internal_blacklist" value="1" {{ old('internal_blacklist', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('national_blacklist_access') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="national_blacklist_access" id="national_blacklist_access" value="1" {{ old('national_blacklist_access', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('white_label_customer_portal_access') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="white_label_customer_portal_access" id="white_label_customer_portal_access" value="1" {{ old('white_label_customer_portal_access', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('customer_portal_orders') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="customer_portal_orders" id="customer_portal_orders" value="1" {{ old('customer_portal_orders', 0) == 1 ? 'checked' : '' }}>
