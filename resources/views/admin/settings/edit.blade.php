    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('user') ? 'is-invalid' : '' }}" type="text" name="user" id="user" value="{{ old('user', $setting->user) }}">
                @if($errors->has('user'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('display_name') ? 'is-invalid' : '' }}" type="text" name="display_name" id="display_name" value="{{ old('display_name', $setting->display_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mail_from_email') ? 'is-invalid' : '' }}" type="text" name="mail_from_email" id="mail_from_email" value="{{ old('mail_from_email', $setting->mail_from_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mail_from_name') ? 'is-invalid' : '' }}" type="text" name="mail_from_name" id="mail_from_name" value="{{ old('mail_from_name', $setting->mail_from_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('facebook_url') ? 'is-invalid' : '' }}" type="text" name="facebook_url" id="facebook_url" value="{{ old('facebook_url', $setting->facebook_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('twitter_url') ? 'is-invalid' : '' }}" type="text" name="twitter_url" id="twitter_url" value="{{ old('twitter_url', $setting->twitter_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('youtube_url') ? 'is-invalid' : '' }}" type="text" name="youtube_url" id="youtube_url" value="{{ old('youtube_url', $setting->youtube_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('linkedin_url') ? 'is-invalid' : '' }}" type="text" name="linkedin_url" id="linkedin_url" value="{{ old('linkedin_url', $setting->linkedin_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_email') ? 'is-invalid' : '' }}" type="text" name="contact_email" id="contact_email" value="{{ old('contact_email', $setting->contact_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_phone') ? 'is-invalid' : '' }}" type="text" name="contact_phone" id="contact_phone" value="{{ old('contact_phone', $setting->contact_phone) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('contact_address') ? 'is-invalid' : '' }}" name="contact_address" id="contact_address">{{ old('contact_address', $setting->contact_address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('data_retain_amount') ? 'is-invalid' : '' }}" type="number" name="data_retain_amount" id="data_retain_amount" value="{{ old('data_retain_amount', $setting->data_retain_amount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_of_data_retention') ? 'is-invalid' : '' }}" type="number" name="duration_of_data_retention" id="duration_of_data_retention" value="{{ old('duration_of_data_retention', $setting->duration_of_data_retention) }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('footer_text') ? 'is-invalid' : '' }}" name="footer_text" id="footer_text">{{ old('footer_text', $setting->footer_text) }}</textarea>
